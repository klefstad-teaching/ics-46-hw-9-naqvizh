...
vector<int> dijkstra_shortest_path(const Graph& G, int source, vector<int>& previous); // DONE?
vector<int> extract_shortest_path(const vector<int>& /*distances*/, const vector<int>& previous, int destination); // DONE?
void print_path(const vector<int>& v, int total); // DONE
